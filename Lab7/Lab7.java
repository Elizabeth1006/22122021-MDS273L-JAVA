...
System.out.println("summary:sepal length:-");
mean(seplen,n);
median(seplen,n);
mode(seplen,n);
max(seplen,n);
...
System.out.println("summary: sepal width:-");
mean(sepwid,n);
median(sepwid,n);
mode(sepwid,n);
max(sepwid,n);
...
System.out.println("summary:petal length:-");
mean(petlen,n);
median(petlen,n);
mode(petlen,n);
max(petlen,n);
...
System.out.println("summary:petal width:-");
mean(petwid,n);
median(petwid,n);
mode(petwid,n);
max(petwid,n);
...
System.out.println("summary:setosa sepal length:-");
...
public static float[] sort(float[] arr,int n){
 ...
 public static void mean(float[] arr,int m){
 ...
 public static void  median(float arr[],int n){
...
public static void mode(float[] arr,int l){
...
int max=0;
  ...
  public static void max(float[] arr,int n){
    float[] arr1 = sort(arr,n);
    float max = arr1[n-1];
    System.out.println("max="+max);;
}

 public static void min(float[] arr,int n){
    float[] arr1 = sort(arr,n);
    float min = arr1[0];
